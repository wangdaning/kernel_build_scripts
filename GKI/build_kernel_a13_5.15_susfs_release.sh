...
git clone https://github.com/TheWildJames/android13-5.15.git
git clone https://github.com/TheWildJames/AnyKernel3.git -b android13-5.15
#git clone https://github.com/TheWildJames/susfs4ksu.git -b gki-android13-5.15-1.5.2
...
#mv manifest_12637695.xml .repo/manifests
#repo init -m manifest_12637695.xml
...
echo "adding susfs"
cd ..
cp ./susfs4ksu/kernel_patches/KernelSU/10_enable_susfs_for_ksu.patch ./android13-5.15/KernelSU/
cp ./susfs4ksu/kernel_patches/50_add_susfs_in_gki-android13-5.15.patch ./android13-5.15/common/
cp ./susfs4ksu/kernel_patches/fs/susfs.c ./android13-5.15/common/fs/
cp ./susfs4ksu/kernel_patches/include/linux/susfs.h ./android13-5.15/common/include/linux/
cp ./susfs4ksu/kernel_patches/fs/sus_su.c ./android13-5.15/common/fs/
cp ./susfs4ksu/kernel_patches/include/linux/sus_su.h ./android13-5.15/common/include/linux/
cd ./android13-5.15/KernelSU/
...
ZIP_NAME="GKI-android13-5.15-KernelSU-SUSFS-$(date +'%Y-%m-%d-%H-%M-%S').zip"
...
RELEASE_NAME="GKI-android13-5.15 With KernelSU & SUSFS"  # Updated release name

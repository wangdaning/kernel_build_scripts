...
cd ./builds
ROOT_DIR="GKI-android12-5.10-2024-01-SUSFS-$(date +'%Y-%m-%d-%I-%M-%p')-release"
...
#git clone https://github.com/TheWildJames/android12-5.10.git -b 2024-01_r17
...
# Get the kernel
echo "Get the kernel..."
cp -r ../../android12-5.10-2024-01 ./
cd ./android12-5.10-2024-01
#repo init -u https://android.googlesource.com/kernel/manifest --depth=1
#sed -i 's/"android12-5.10-2024-01"/"deprecated\/android12-5.10-2024-01"/g' ./manifest_12385117.xml
#mv manifest_12385117.xml .repo/manifests
#repo init -m manifest_12385117.xml
...
echo "adding susfs"
cd ..
cp ./susfs4ksu/kernel_patches/KernelSU/10_enable_susfs_for_ksu.patch ./android12-5.10-2024-01/KernelSU/
cp ./susfs4ksu/kernel_patches/50_add_susfs_in_gki-android12-5.10.patch ./android12-5.10-2024-01/common/
cp ./susfs4ksu/kernel_patches/fs/susfs.c ./android12-5.10-2024-01/common/fs/
cp ./susfs4ksu/kernel_patches/include/linux/susfs.h ./android12-5.10-2024-01/common/include/linux/
cp ./susfs4ksu/kernel_patches/fs/sus_su.c ./android12-5.10-2024-01/common/fs/
cp ./susfs4ksu/kernel_patches/include/linux/sus_su.h ./android12-5.10-2024-01/common/include/linux/
cd ./android12-5.10-2024-01/KernelSU/
...
ZIP_NAME="GKI-android12-5.10.198-KernelSU-SUSFS-$(date +'%Y-%m-%d-%H-%M-%S').zip"
...
RELEASE_NAME="GKI-android12-5.10.198 With KernelSU & SUSFS"  # Updated release name

...
git clone https://github.com/TheWildJames/android13-5.10.git -b 2024-09_r2
git clone https://github.com/TheWildJames/AnyKernel3.git -b android13-5.10
...
mv manifest_12401394.xml .repo/manifests
repo init -m manifest_12401394.xml
...
echo "adding susfs"
cd ..
cp ./susfs4ksu/kernel_patches/KernelSU/10_enable_susfs_for_ksu.patch ./android13-5.10/KernelSU/
cp ./susfs4ksu/kernel_patches/50_add_susfs_in_gki-android13-5.10.patch ./android13-5.10/common/
cp ./susfs4ksu/kernel_patches/fs/susfs.c ./android13-5.10/common/fs/
cp ./susfs4ksu/kernel_patches/include/linux/susfs.h ./android13-5.10/common/include/linux/
cp ./susfs4ksu/kernel_patches/fs/sus_su.c ./android13-5.10/common/fs/
cp ./susfs4ksu/kernel_patches/include/linux/sus_su.h ./android13-5.10/common/include/linux/
cd ./android13-5.10/KernelSU/
...
cd ../../
cp ./lineage_kernel_patches/69_hide_lineage.patch ./android13-5.10
cd ./android13-5.10
...
REPO_NAME="android13-5.10"  # Replace with your repository name
TAG_NAME="v$(date +'%Y.%m.%d-%H%M%S')"   # Unique tag with timestamp to ensure multiple releases on the same day
RELEASE_NAME="GKI-android13-5.10 With KernelSU & SUSFS"  # Updated release name

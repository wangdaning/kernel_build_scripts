...
mkdir oneplus11_u
cd ./oneplus11_u
repo init -u https://github.com/TheWildJames/oneplus_kernel_manifest.git -b oneplus/sm8550 -m oneplus11_u.xml
repo sync -j$(nproc)
...
ZIP_NAME="Anykernel3-OP-A15-android14-5.15-KernelSU-SUSFS-$(date +'%Y-%m-%d-%H-%M-%S').zip"
...
RELEASE_NAME="OP12 A15 android14-5.15 With KernelSU & SUSFS"  # Updated release name
